        ...
        if form.is_valid():
            ...
            if method == 'email':
                ...
                send_mail(
                        ...
                        Merci de faire confiance à Ghislaine Cosmetic.

                        Cordialement,
                        L'équipe Ghislaine Cosmetic
                        ''',
                        'no-reply@ghislainecosmetic.com',  # Utilisez une adresse no-reply dédiée si possible
                        [user.email],
                        fail_silently=False,
)

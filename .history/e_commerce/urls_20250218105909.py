...
urlpatterns = [
    ...
    path('cart/add/detail/<uuid:product_id>/', add_to_cart_detail, name='add_to_cart_detail'),
    path('cart/add/detail/produit/<uuid:product_id>/', add_to_cart_detail_product, name='add_to_cart_detail_product'),

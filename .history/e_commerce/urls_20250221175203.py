...
urlpatterns = [
    ...
    path('products/list', ProductsListView.as_view(), name='product-list'),
    ...
    #path('products/<uuid:product_id>/update-stock/', UpdateProductStockView.as_view(), name='update-stock'),
    ...
    path('orders/list/gestion', order_list_gestion, name='order_list_gestion'),
    ######################################## view de connexion  #######################

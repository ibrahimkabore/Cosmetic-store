...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        max_length=100, unique=True, verbose_name="Teint Category Name"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        db_index=True,
                        max_length=100,
                        verbose_name="Teint Category Name",
                    ),
                ),
                (
                    "history_id",
            ...
            options={
                "verbose_name": "historical Parent Category",
                "verbose_name_plural": "historical Parent Categories",
                "db_table": "ParentCategory_history",
                "ordering": ("-history_date", "-history_id"),
                "get_latest_by": ("history_date", "history_id"),
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.DO_NOTHING,
                        related_name="+",
                        to="e_commerce.parentcategory",
                        verbose_name="Teint Category",
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=2,
                        max_digits=10,
                        verbose_name="Product Price at Purchase",
                    ),
                ),
                (
                    "order",
